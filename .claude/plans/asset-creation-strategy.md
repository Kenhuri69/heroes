...
- [x] **Avatars de héros** (6 bustes 256²) : haven/arcane-hunters/necropolis ×
      ...
      `assets/heroes/`.
- [~] **Fonds** (L2, 8 scènes) : title ✅, town-haven ✅, town-arcane-hunters ✅, town-necropolis ✅, combat-grass ✅, combat-swamp ✅. Anti-étincelle ajouté aux prompts (gen_prompts.py).
      Reste : victory, defeat.
- [ ] Logo (L2)
