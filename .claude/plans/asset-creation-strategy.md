...
- [x] **Avatars de héros** (6 bustes 256²) : haven/arcane-hunters/necropolis ×
      ...
      `assets/heroes/`.
- [~] **Fonds** (L2, 8 scènes) : title ✅, town-haven ✅. Anti-étincelle ajouté aux prompts (gen_prompts.py).
      Reste : town-arcane-hunters/necropolis, combat-grass/swamp, victory, defeat.
- [ ] Logo (L2)
