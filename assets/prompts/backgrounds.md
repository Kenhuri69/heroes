# Fonds d'ambiance (Règle D — pièces uniques)

> Générés par `tools/assets/gen_prompts.py`. Un prompt = une image 1920×1080.
> Staging : `assets/backgrounds/<id>.jpg` (< 500 Ko, JPEG q80-85 accepté).
