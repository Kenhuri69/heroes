...
> Règle A (sprites 512² painterly, alpha strict après extraction) de `docs/12-assets-style-guide.md`. Grille **4×1**,
> ordre row-major. Planche cible ≥ 2048×512 px.

## Prompt (à coller dans Gemini — Nano Banana/Copilot en repli)

```
Character sheet, 4 mounted fantasy heroes of different armies in a 4x1 grid,
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids hero-haven,hero-arcane-hunters,hero-necropolis,hero-sylvan-court \
