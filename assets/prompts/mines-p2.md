# Planche — mines de ressources (objets de carte) — planche 2/2
...
```
Building sheet, 1 small fantasy resource mines in a 1x1 grid,
...
cell 1: "resonance mine" — a fantasy mine producing resonance
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids mine-resonance \
  --out assets/raster_src --qc /tmp/qc-mines-p2.png
```
