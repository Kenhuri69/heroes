# Planche — tas de ressources ramassables (objets de carte) — planche 2/2
...
```
Item sheet, 1 small fantasy resource piles lying on the ground in a 1x1 grid,
...
cell 1: "resonance pile" — a humming tuning-fork crystal on a small lacquered stand
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids pile-resonance \
  --out assets/raster_src --qc /tmp/qc-resource-piles-p2.png
```
