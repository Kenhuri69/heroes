# Planche — unités dungeon (T1→T7) — planche 2/2
...
cell 1: tier 2 unit "Unleashed Fury (fr: Furie déchaînée)" — charging forward, swift and agile
cell 2: tier 3 unit "Minotaur Guard (fr: Gardien minotaure)" — steady stance
cell 3: tier 4 unit "Black Rider (fr: Cavalier noir)" — charging forward, swift and agile
cell 4: tier 5 unit "Shadow Matron (fr: Matriarche d'ombre)" — swift and agile
cell 5: tier 6 unit "Chthonian Hydra (fr: Hydre chthonienne)" — steady stance
cell 6: tier 7 unit "Black Dragon (fr: Dragon noir)" — large spread wings, airborne pose, swift and agile
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids t2-furie-sanglante-elite,t3-minotaure-elite,t4-chevaucheur-tenebres-elite,t5-sorciere-ombre-elite,t6-hydre-elite,t7-dragon-ombre-elite \
  --out assets/raster_src --qc /tmp/qc-units-dungeon-p2.png
```
