# Planche — unités haven (T1→T7) — planche 2/2
...
cell 1: tier 2 unit "Marksman (fr: Archer d'Élite)" — aiming a ranged weapon, steady stance
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids t2-archer-elite,t3-frere-lame-elite,t4-griffon-elite,t5-pretresse-elite,t6-chevalier-griffon-elite,t7-ange-elite \
  --out assets/raster_src --qc /tmp/qc-units-haven-p2.png
```
