# Planche — unités necropolis (T1→T7)
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids t1-squelette,t2-zombie,t3-spectre,t4-vampire,t5-liche,t6-cavalier-funeste,t7-dragon-os \
  --out assets/raster_src --qc /tmp/qc-units-necropolis.png
```
