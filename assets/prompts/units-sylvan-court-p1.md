# Planche — unités sylvan-court (T1→T7) — planche 1/2
...
cell 1: tier 1 unit "Lucine" — large spread wings, airborne pose, steady stance
cell 2: tier 2 unit "Sylvan Archer (fr: Archer Sylvestre)" — aiming a ranged weapon, steady stance
cell 3: tier 3 unit "Dryad (fr: Dryade)" — steady stance
cell 4: tier 4 unit "Silver Wolf (fr: Loup d'Argent)" — swift and agile
cell 5: tier 5 unit "Unicorn (fr: Licorne)" — swift and agile
cell 6: tier 6 unit "Treant (fr: Tréant)" — steady stance
cell 7: tier 7 unit "Elder of the Wood (fr: Aïeul de la Forêt)" — swift and agile
cell 8: tier 1 unit "Nymph (fr: Nymphe)" — large spread wings, airborne pose, swift and agile
...
python3 tools/assets/sheet_extract.py <planche.png> \
  ...
  --ids t1-lucine,t2-archer-sylvestre,t3-dryade,t4-loup-argent,t5-licorne,t6-treant,t7-aieul,t1-lucine-elite \
  --out assets/raster_src --qc /tmp/qc-units-sylvan-court-p1.png
```
