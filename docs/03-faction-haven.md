...
Bâtiments communs : cf. doc 02 §4.1. **Graal** (`haven-grail`, gaté par le
méta-puzzle obélisques → fouille) : bastion sacré — `heroAura` moral +2 / défense
de garnison +5 / mouvement +400 (town-scoped). Cf. doc 02 §2.2 (table par-faction).
Spécifiques Haven :
