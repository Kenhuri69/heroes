...
> **Séraphine** (`haven-ch3` — « ses visions viennent-elles d'Elrath ou de ce
> qui dort sous le sceau ? », drapeaux `seraphine-faith`/`seraphine-doubt`) et
> **Vhalen** (`necropolis-ch2` — l'archiviste découvre que le sceau dévore les
> âmes de son peuple pour Heresh : le réparer par doctrine ou laisser couler pour
> nourrir les siens, drapeaux `vhalen-doctrine`/`vhalen-people`) livrés. *Restent :*
> Mère Corbeau (Necropolis), Evadne, Marchmont (Arcane Hunters).
