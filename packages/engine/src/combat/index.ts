...
/** Renforts en combat (doc 18 B3) — validation + handler + gate d'affichage UI (PvE, opt-in). */
export { validateCallReinforcements, handleCallReinforcements, canCallReinforcements } from './reinforce';
